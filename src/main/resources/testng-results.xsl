...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="htmlHead">
        <head>
            <title>
                <xsl:value-of select="testng:getVariableSafe($testNgXslt.reportTitle, 'AutoTest4IOS Results')"/>
            </title>
    ...
    <xsl:template name="powered-by">
        <div style="margin-top: 15px; color: gray; text-align: center; font-size: 9px;">
            Generated with
           <!--  <a href="mailto:color.yyan@gmail.com" style="color: #8888aa;" target="_blank">中银开放平台 @ Copyright 2013 </a>
            -->
        </div>
    </xsl:template>
